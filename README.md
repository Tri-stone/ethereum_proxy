...
curl -H "Content-Type:application/json" -d '{"jsonrpc":"2.0","method":"eth_getTransactionByHash","params":["4f7a0a9802f1cc9620068ba3de4f2588ecef18d129b6b0ba7c3bbd3863a11776"],"id":1}' 127.0.0.1:5000
...
curl -H "Content-Type:application/json" -d '{"jsonrpc":"2.0","method":"eth_getLogs","params":[{"fromBlock":"21156","toBlock":"21157"}],"id":1}' 127.0.0.1:5000
...
// just for test
curl -H "Content-Type:application/json" -d '{"jsonrpc":"2.0","method":"eth_getFilter","params":["0xfd5ed768f06cfbd031f16b3a3533c283"],"id":1}' 127.0.0.1:5000
